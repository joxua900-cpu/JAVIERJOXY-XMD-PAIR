...
const BOT_NAME = "JAVIERJOXY-XMD";
const DEFAULT_THUMBNAIL ="https://files.catbox.moe/tehtjf.png"
...
const createContext = (userJid, options = {}) => ({
    contextInfo: {
        ...
        externalAdReply: {
            ...
            sourceUrl: options.sourceUrl || "https://wa.me/255694710183", // link to bot or business
